 ...
 * ------------------------------------------------------------------------- */
#define BUILD_VARIANT_LABEL "gts9fepwifi-X610XXSFEZH7-app"
#define PHYS_P0_ORACLE 1
#define SLIDE_ROUTE SLIDE_ROUTE_FPSIMD

#ifndef BUILD_FINGERPRINT
#define BUILD_FINGERPRINT \
  "samsung/gts9fepwifixx/gts9fepwifi:16/BP4A.251205.006/X610XXSFEZH7:user/release-keys"
#endif
...
#define P0_FINGERPRINT_HEADER \
  "targets/gts9fepwifi-X610XXSFEZH7/p0_fingerprint.h"
...
#define KMALLOC_CACHES_OFF 0x01b05370ULL
#define ANON_PIPE_BUF_OPS_OFF 0x019134e0ULL
...
#define ASHMEM_FOPS_OFF 0x01ab4308ULL
